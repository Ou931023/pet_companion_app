...
## CR-0106A — iOS Debug Signing Compatibility

### 模式
**小範圍跨邊界簽章修正**（architecture-agent 核准；frontend-ux-agent / iOS build config）。不改正式 auth API、不改 Firebase session 契約、不移除 App Store Release 的 Sign in with Apple。
