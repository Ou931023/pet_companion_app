...
class LegalConfig {
  ...
  static const String privacyPolicyUrl = String.fromEnvironment(
    'PRIVACY_POLICY_URL',
    defaultValue: 'https://ou931023.github.io/pet_companion_app/privacy.html',
  );
  ...
  static const String termsOfServiceUrl = String.fromEnvironment(
    ...
    defaultValue: 'https://ou931023.github.io/pet_companion_app/terms.html',
  );
  ...
  static const String supportUrl = String.fromEnvironment(
    'SUPPORT_URL',
    defaultValue: 'https://ou931023.github.io/pet_companion_app/support.html',
  );
  ...
  static const String contactEmail = String.fromEnvironment(
    'CONTACT_EMAIL',
    defaultValue: 'aicompanion.support@gmail.com',
  );
