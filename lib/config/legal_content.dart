...
class LegalContent {
  ...
  static const List<ConsentHighlight> consentHighlights = [
    ...
    ConsentHighlight(
      title: '心情小日記由你決定分享',
      description: '你可以主動寫下心情。日記預設只有自己能看，只有你另外勾選分享的那一篇，'
          '才會讓已授權的照護人員與管理員看到；你也可以停止分享或刪除。私人對話不會自動變成日記。',
    ),
    ConsentHighlight(
  ...
  static const List<LegalSection> privacyPolicySections = [
    ...
    LegalSection(
      ...
      paragraphs: [
        ...
        '心情小日記：你主動寫下的心情與文字。日記預設只有自己能看，不會從私人對話自動產生。',
      ],
    ),
    LegalSection(
      heading: '我們怎麼使用這些資料',
      paragraphs: [
        ...
        '只有你在個別日記中主動勾選分享時，才讓已授權的照護人員與管理員看到該篇日記。',
    ...
    LegalSection(
      ...
      paragraphs: [
        ...
        '你可以查看、刪除心情小日記，或隨時停止分享某一篇日記。停止分享後，照護後台不再提供該篇內容。',
        '你可以申請刪除整個帳號與相關資料。',
